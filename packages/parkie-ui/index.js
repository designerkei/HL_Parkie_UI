...
export const parkiePackage = freeze({
...
export const parkieUiRegistrySmoke = freeze({
  name: parkiePackage.name,
  ready: true,
});

export const parkieTokens = freeze({
  color: freeze({
    brand: freeze({
      50: '#EDFDFF',
      100: '#D1FAFF',
...
export const parkieCssVariables = freeze({
...
export function createParkieThemeAttributes(overrides = {}) {
  return {
...
export function getParkieCssVariable(name) {
  return parkieCssVariables[name] || null;
}

export function createParkieTokenStyleText(options = {}) {
